...
func main() {
	...
	v2Setting := []chengyu.Blank{
		...
		{HeadFoot: []chengyu.BlankItem{
			chengyu.BlankItem{HeadUseCyIndex: 1, Head: 2, Foot: 1},
			chengyu.BlankItem{HeadUseCyIndex: 2, Head: 2, Foot: 2},
			chengyu.BlankItem{HeadUseCyIndex: 3, Head: 2, Foot: 3},
		}},
		{HeadFoot: []chengyu.BlankItem{
			chengyu.BlankItem{HeadUseCyIndex: 1, Head: 3, Foot: 2},
			chengyu.BlankItem{HeadUseCyIndex: 2, Head: 3, Foot: 3},
			chengyu.BlankItem{HeadUseCyIndex: 3, Head: 3, Foot: 4},
		}},
		{HeadFoot: []chengyu.BlankItem{
			chengyu.BlankItem{HeadUseCyIndex: 1, Head: 4, Foot: 1},
			chengyu.BlankItem{HeadUseCyIndex: 2, Head: 4, Foot: 2},
			chengyu.BlankItem{HeadUseCyIndex: 3, Head: 4, Foot: 3},
		}},
	}
